...
public class StudentDetail {
     ...
     * @mbg.generated Fri Apr 05 15:17:56 CST 2019
     */
    public StudentDetail(Integer id, Integer owner, Integer teacher, Integer status, String projectTitle, String fileUri, Integer reviewTimes, Integer college, Integer major, Float gpa, String address, Boolean allottedDisabled, Boolean commitDisabled, Date updateTime, Date createTime) {
        this.id = id;
        this.owner = owner;
