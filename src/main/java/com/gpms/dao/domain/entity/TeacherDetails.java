...
public class TeacherDetails {
     ...
     * @mbg.generated Fri Apr 05 15:17:56 CST 2019
     */
    public TeacherDetails(Integer id, Integer owner, Integer title, Integer college, Integer major, Integer studentNumber, Integer studentMark, Boolean acceptDisabled, Date updateTime, Date createTime) {
        this.id = id;
        this.owner = owner;
        this.title = title;
